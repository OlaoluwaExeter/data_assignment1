...
This project focuses on building a Health Data Analytics System using MySQL, Command-Line tools, and GitHub for version control.
The dataset contains four main entities — Hospitals, Doctors, Patients, and Prescriptions — which collectively form a relational database that can be queried for insights such as:
•	Which doctors work at which hospitals
•	Patient prescription history
•	The most active prescribing doctor
•	The hospital with maximum capacity, etc.
The entire process — from data import, table creation, normalization, query writing, and GitHub versioning — was executed in the command line for reproducibility and automation.
...
3. Verified foreign key integrity:
4. No missing references were found, confirming successful normalization.
